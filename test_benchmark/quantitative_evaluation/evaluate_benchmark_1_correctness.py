...
def parse_args():
    """
    PRED_GENERIC="/home/tony/MiniGPT-4/results/daisee_inference.json"
    OUTPUT_DIR="/home/tony/MiniGPT4/gpt_evaluation/vicuna_daisee_image.json"
...
def merge_caption_preds(
    pred_file:str='/home/tony/MiniGPT-4/results/inference.json',
    caption_file:str='/home/tony/MiniGPT-4/daisee_captions/test_filter_cap.json',
    save_file:str='/home/tony/MiniGPT-4/results/daisee_inference.json'
)->dict:
    ...
    q = "What is the student's engagement level?"
    out = []
    for pred in preds:
        subject = pred['subject']
        for cap in caps:
            if cap['video_id'] == subject:
                out.append({
                    'video_id':subject,
                    'pred':pred['answer'],
                    'A':cap['caption'],
...
def main():
    ...
    if not os.path.exists(args.pred_path):
        pred_contents = merge_caption_preds()    
    else:
